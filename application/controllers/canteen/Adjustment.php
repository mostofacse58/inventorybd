...
class Adjustment extends My_Controller {
    function __construct(){
        parent::__construct();
        $this->load->model('canteen/Adjustment_model');
     }
    ...
    function lists(){
      $data=array();
        ...
        $config['base_url']=base_url().'canteen/Adjustment/lists/';
      ...
      //////////////////////////////////////////
        ...
        $data['display']='canteen/adjustmentlist';
    ...
    function add(){
      ...
      $data['display']='canteen/addadjustment';
      $this->load->view('admin/master',$data);
    ...
    function save($adjustment_id=FALSE){
        ...
        redirect("canteen/Adjustment/lists");
       }else{
          $data['heading']='Add Adjustment';
          if($adjustment_id){
            $data['heading']='Edit Adjustment';
