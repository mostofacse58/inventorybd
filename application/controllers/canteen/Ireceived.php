...
class Ireceived extends My_Controller {
    function __construct(){
        parent::__construct();
        $this->load->model('canteen/Ireceived_model');
    ...
    function lists(){
       $data=array();
        ...
        $config['base_url']=base_url().'canteen/Ireceived/lists/';
      ...
      //////////////////////////////////////////
        ...
        $data['display']='canteen/ireceivedlist';
       ...
       function viewreceived($issue_id=FALSE){
        ...
        $data['display']='canteen/ireceiveView';
        $this->load->view('admin/master',$data);
    ...
    function view($issue_id=FALSE){
      ...
      redirect("canteen/Ireceived/lists");
    }
