...
class Ireturn extends My_Controller {
    function __construct(){
        parent::__construct();
        $this->load->model('canteen/Ireturn_model');
     }
    ...
    function lists(){
      $data=array();
        ...
        $config['base_url']=base_url().'canteen/Ireturn/lists/';
      ...
      //////////////////////////////////////////
        ...
        $data['display']='canteen/ireturnlist';
    ...
    function add(){
      ...
      $data['display']='canteen/addireturn';
      $this->load->view('admin/master',$data);
    ...
    function save($ireturn_id=FALSE){
        ...
        redirect("canteen/Ireturn/lists");
       }else{
