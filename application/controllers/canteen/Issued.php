...
class Issued extends My_Controller {
    function __construct(){
        parent::__construct();
        $this->load->model('canteen/Issued_model');
    ...
    function lists(){
      $data=array();
        ...
        $config['base_url']=base_url().'canteen/Issued/lists/';
        ...
        $data['display']='canteen/issuedlist';
    ...
    function add(){
      ...
      $data['display']='canteen/addissued';
      $this->load->view('admin/master',$data);
    }
         ...
         if ($this->form_validation->run() == TRUE) {
          ...
          // echo "$fifoStock  =$preIssueQty =$main_stock"; exit();
            ...
            if($quantity[$i]>($fifoStock+$preIssueQty)) {
              ...
              if($issue_id==FALSE)
                redirect("canteen/Issued/add");  
              else 
                redirect("canteen/Issued/edit/$issue_id"); 
            }
            $i++;
          }
        /////////////////////////////////
