...
class Items extends My_Controller {
    function __construct()
    {
        ...
        $this->load->model('canteen/items_model');
     }
    ...
    function lists(){
     //echo $controll=$this->router->fetch_directory().$this->router->fetch_class();
      ...
      //////////////////
        ...
        $config['base_url']=base_url().'canteen/Items/lists/';
        ...
        $data['display']='canteen/itemslist';
