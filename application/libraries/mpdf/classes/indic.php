...
function substituteIndic($earr, $lang, $font) {
	...
	// BENGALI vowels [09BF 09C7 09C8]
		...
		$vstr = preg_replace('/(09BF|09C7|09C8|0985) 09B0 09CD/', '\\1 E068', $vstr);
...
//echo $vstr.'<br />'; exit;
	...
	// BENGALI Shift Reph [E068]
		...
		$bnfullvowels = "0985|0986|0987|0988|0989|098A|098B|098C|098D|098F|0990|0993|0994";
		...
		$vstr = preg_replace('/0020 (09C7)/', '0020 E1CF', $vstr);		
	}
