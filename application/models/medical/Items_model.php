  ...
  public function get_count(){
    ...
    function lists2() {
      ...
      $result=$this->db->query("SELECT p.*,c.category_name,
          ...
          LEFT JOIN brand_info b ON(p.brand_id=b.brand_id)
          LEFT JOIN user u ON(u.id=p.user_id) 
          WHERE p.department_id=$department_id AND p.product_type=2 AND p.medical_yes=1
    ...
    function save($product_id) {
        ...
        $data['product_code']='BDMED'.$random.str_pad($product_code_count + 1, 6, '0', STR_PAD_LEFT);
