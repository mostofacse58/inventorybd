...
<div class="widget-control pull-right">
  ...
  <div class="box-body">
    ...
    <form class="form-horizontal" action="<?php echo base_url();?>canteen/Invoiceaudit/lists" method="GET" enctype="multipart/form-data">
    ...
    <label class="col-sm-1 control-label">Search By </label>
        ...
        <div class="col-sm-3">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/Invoiceaudit/lists">All</a>
      </div>
      </div>
    </form>
      ...
      <table class="table table-bordered table-striped" style="width:100%;border:#00" >
        <thead>
          <tr>
            ...
            <th style="width:8%;">Invoiceaudit No</th>
        ...
        if($list&&!empty($list)): $i=$page+1;
          ...
          <tr>
            ...
            <span class="btn btn-xs btn-<?php echo ($row->invoice_status==3||$row->invoice_status==5)?"danger":"success";?>">
              <?php 
              if($row->invoice_status==1) echo "Draft";
              elseif($row->invoice_status==2) echo "Pending";
              elseif($row->invoice_status==3) echo "Pending";
              elseif($row->invoice_status==4) echo "Audited";
              elseif($row->invoice_status==5) echo "Approved";
              elseif($row->invoice_status==6) echo "Received";
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>canteen/Invoiceaudit/view/<?php echo $row->invoice_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <li> <a href="<?php echo base_url()?>canteen/Invoiceaudit/viewpdf/<?php echo $row->invoice_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>PDF</a></li>
              <?php if($row->invoice_status==3){ ?>
              <li><a href="<?php echo base_url()?>canteen/Invoiceaudit/checkform/<?php echo $row->invoice_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Audit Qty</a></li>
              <li><a href="<?php echo base_url()?>canteen/Invoiceaudit/received/<?php echo $row->invoice_id;?>">
