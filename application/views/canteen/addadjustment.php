...
function getitemAllFifo(){
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Adjustment/getproductinfo',
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Adjustment/getitemAllFifo',
    data:{ITEM_CODE:ITEM_CODE,department_id:department_id},
...
<div class="widget-control pull-right">
   ...
   <div class="box box-info">
    <!-- /.box-header -->
      <!-- form start -->
      <form class="form-horizontal" action="<?php echo base_url();?>canteen/Adjustment/save<?php if(isset($info)) echo "/$info->adjustment_id"; ?>" method="POST" enctype="multipart/form-data"  onsubmit="formsubmit();">
        <div class="box-body">
      <!-- ///////////////////// -->
      ...
      <div class="form-group">
        ...
        <div class="box-footer">
           <div class="col-sm-4">
            <a href="<?php echo base_url(); ?>canteen/Adjustment/lists" class="btn btn-info"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a></div>
           <div class="col-sm-4">
