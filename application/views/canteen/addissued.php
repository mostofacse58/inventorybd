...
function getprwiseitem(){
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Issued/getprinfo',
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Issued/getprwiseitem',
    data:{requisition_no:requisition_no},
...
$(document).ready(function(){
 ...
 var issue_type=$("#issue_type").val(); 
  ...
  $("#add_item").autocomplete({
        ...
        $.ajax({
            type: 'get',
            url: '<?= base_url('canteen/Issued/suggestions'); ?>',
            dataType: "json",
            data: {
                term: request.term
            },
...
////////////// end Add Item///////////////////
  ...
  var requisition_no=$("#requisition_no").val();
      ...
      $.ajax({
        type:"post",
        url:"<?php echo base_url()?>"+'canteen/Issued/getFilewiseitem',
...
<div class="row">
    <div class="col-md-12">
      ...
      <!-- /.box-header -->
        <form class="form-horizontal" action="<?php echo base_url(); ?>canteen/Issued/save<?php if (isset($info)) echo "/$info->issue_id"; ?>" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
         <div class="box-body">
...
<tbody>
 ...
 $id=0;
  ...
  <div class="box-footer">
      <div class="col-sm-4"><a href="<?php echo base_url(); ?>canteen/Issued/lists" class="btn btn-info">
