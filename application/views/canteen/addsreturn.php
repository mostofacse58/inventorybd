...
function getprwiseitem(){
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Sreturn/getprinfo',
  ...
  $.ajax({
    type:"post",
    url:"<?php echo base_url()?>"+'canteen/Sreturn/getprwiseitem',
    data:{requisition_no:requisition_no},
...
$(document).ready(function(){
  ...
  $("#add_item").autocomplete({
        ...
        $.ajax({
            type: 'get',
            url: '<?= base_url('canteen/Sreturn/suggestions'); ?>',
            dataType: "json",
            data: {
                term: request.term
            },
...
<div class="row">
    <div class="col-md-12">
      ...
      <!-- /.box-header -->
        <form class="form-horizontal" action="<?php echo base_url(); ?>canteen/Sreturn/save<?php if (isset($info)) echo "/$info->issue_id"; ?>" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
         <div class="box-body">
...
<tbody>
 ...
 $id=0;
  ...
  <div class="box-footer">
      <div class="col-sm-4"><a href="<?php echo base_url(); ?>canteen/Sreturn/lists" class="btn btn-info">
