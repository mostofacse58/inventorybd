...
href="<?php echo base_url(); ?>canteen/extragrn/add">
...
Add New
            ...
            <!-- /.box-header -->
  <div class="box-body">
    <form class="form-horizontal" action="<?php echo base_url();?>canteen/extragrn/lists" method="GET" enctype="multipart/form-data">
    ...
    <label class="col-sm-1 control-label">Search By </label>
        ...
        <div class="col-sm-2">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/extragrn/lists">All</a>
      </div>
    </div>
        ...
        if($list&&!empty($list)): $i=$page+1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>canteen/extragrn/view/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <li> <a href="<?php echo base_url()?>canteen/extragrn/viewpdf/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>PDF</a></li>
              <?php if($row->status==1){ ?>
              <li><a href="<?php echo base_url()?>canteen/extragrn/submit/<?php echo $row->purchase_id;?>"><i class="fa fa-arrow-circle-o-right tiny-icon"></i>Submit</a></li>
              <?php } ?>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>canteen/extragrn/delete/"+rowId;
}else{
  return false;
}
});
