...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/Issued/add">
...
Add Issue
            ...
            <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>canteen/Issued/lists" method="GET" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/Issued/lists">All</a>
            </div>
            </div>
             <!-- /.box-body -->
          </form>
            ...
            foreach($list as $row):
              ...
              <tr>
                ...
                <div class="btn-group">
                    ...
                    <li> <a href="<?php echo base_url()?>canteen/Issued/view/<?php echo $row->issue_id;?>" target="_blank">
                      <i class="fa fa-eye tiny-icon"></i>View</a></li>
                      <?php if($row->issue_status==1){ ?>
                      <li> <a href="<?php echo base_url()?>canteen/Issued/edit/<?php echo $row->issue_id;?>">
                    ...
                    <?php } ?>
                  <?php } ?>
                      <!--  <li> <a href="<?php echo base_url()?>canteen/Issued/returnback/<?php echo $row->issue_id;?>">
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>canteen/Issued/delete/"+rowId;
}else{
  return false;
}
});
