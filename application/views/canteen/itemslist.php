...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/items/add">
...
Add New 添新
            ...
            <!-- /.box-header -->
      <div class="box-body">
        <form class="form-horizontal" action="<?php echo base_url();?>canteen/items/lists" method="POST" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <label class="col-sm-2 control-label">Iteam Code物料编码/Name 名称</label>
          <div class="col-sm-2">
        ...
        <div class="col-sm-1">
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/items/lists">All</a>
        </div>
        </div>
      </form>
      <div class="table-responsive table-bordered">
        ...
        <tr>
            ...
            <th style="text-align:center;width:7%">Description</th>
        </tr>
        </thead>
        <tbody>
        <?php
            ...
            <tr>
              ...
              <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?php echo base_url()?>canteen/items/views/<?php echo $row->product_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                    <?php if($row->product_status==1){  ?>
                    <li><a href="<?php echo base_url()?>canteen/items/deactivated/<?php echo $row->product_id;?>"><i class="fa ffa fa-trash tiny-icon"></i>Deactive</a></li>
                    <?php } ?>
                    <?php if($row->product_status==2){ ?>
                    <li><a href="<?php echo base_url()?>canteen/items/activated/<?php echo $row->product_id;?>"><i class="fa ffa fa-ok tiny-icon"></i>Active</a></li>
                    <?php } ?>
                    <li>  <a href="<?php echo base_url()?>canteen/items/edit/<?php echo $row->product_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit 编辑</a></li>
...
$(".delete").click(function(e){
  ...
  $.ajax({
   type:"GET",
   url:"<?php echo base_url();?>canteen/items/checkItemsUse/"+rowId,
     success:function(data){
      if(data=="EXISTS"){
        $("#alertMessageHTML").html("Sorry, this information can't be deleted.!!");
      $("#alertMessagemodal").modal("show");
      }else{
        location.href="<?php echo base_url();?>canteen/items/delete/"+rowId;
     }
},
error:function(){
  console.log("failed");
