  ...
  <div class="row">
       ...
       <div class="box box-primary">
        ...
        <div class="widget-head">
          ...
          <div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
      <div class="box-body">
         <form class="form-horizontal" action="<?php echo base_url();?>canteen/Requisitionrec/lists" method="GET" enctype="multipart/form-data">
          <div class="box-body">
          ...
          <div class="row form-group">
            ...
            <div class="col-sm-2">
                <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/Requisitionrec/lists">All</a>
            </div>
          </div>
          </div>
          <!-- /.box-body -->
      ...
      <table id="" class="table table-bordered table-striped" style="width:100%;border:#000">
          ...
          <tr>
            ...
            <th style="text-align:center;width:10%">Requisitionrec NO</th>
            <th style="width:10%;">Requisitionrec Date</th>
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu pull-right" role="menu">
                ...
                <li> <a href="<?php echo base_url()?>canteen/Requisitionrec/received/<?php echo $row->requisition_id;?>">
                  <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Receive</a></li>
                <?php } ?>
                <!-- <?php if($row->requisition_status==3){ ?>
                <li> <a href="<?php echo base_url()?>canteen/Invoice/adInvoice/<?php echo $row->requisition_id;?>">
                  <i class="fa fa-plus tiny-icon"></i>Make Invoice</a></li>
                <?php } ?> -->
                <li> <a href="<?php echo base_url()?>canteen/Requisitionrec/view2/<?php echo $row->requisition_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
                <li> <a href="<?php echo base_url()?>canteen/Requisitionrec/view/<?php echo $row->requisition_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>pdf</a></li>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>canteen/Requisitionrec/delete/"+rowId;
}else{
  return false;
}
});
