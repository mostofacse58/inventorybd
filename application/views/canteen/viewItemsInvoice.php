...
<table style="width: 100%">
   <tr>
    ...
    <th style="text-align: left;width: 50%"> <?php  echo "$info->supplier_name"; ?></th>
    <th style="text-align: left;width: 15%">INVOICE NO:</th>
    <th style="text-align: left;width: 20%"> <?php if(isset($info)) echo $info->invoice_no; ?>
    </th>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <th style="text-align: left">
      <?php if(isset($info)) echo $info->ref_no; ?></th>
    <th style="text-align: left">Invoice Date: </th>
    <th style="text-align: left"><?php if(isset($info)) echo findDate($info->purchase_date); ?></th>
  </tr>
  <tr>
