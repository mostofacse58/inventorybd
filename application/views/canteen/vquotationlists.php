     ...
     <div class="box box-primary">
      ...
      <div class="widget-head">
        ...
        <div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
      <div class="box-body">
         <form class="form-horizontal" action="<?php echo base_url();?>canteen/Vquotation/lists" method="GET" enctype="multipart/form-data">
          <div class="box-body">
        ...
        <div class="col-sm-2">
          <input type="text" name="to_date" readonly="" class="form-control date" placeholder="To Date" value="<?php  echo set_value('to_date'); ?>">
            ...
            <div class="col-sm-2">
                <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>canteen/Vquotation/lists">All</a>
            </div>
          </div>
          </div>
          <!-- /.box-body -->
        ...
        if($list&&!empty($list)): $i=1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>canteen/Vquotation/view/<?php echo $row->quotation_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <li> <a href="<?php echo base_url()?>canteen/Vquotation/viewpdf/<?php echo $row->quotation_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>pdf</a></li>
              <li> <a href="<?php echo base_url()?>canteen/Vquotation/excelload/<?php echo $row->quotation_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>Excel</a></li>
              <?php if($row->status==2){ ?>
              
              <li> <a href="<?php echo base_url()?>canteen/Vquotation/edit/<?php echo $row->quotation_id;?>"><i class="fa fa-edit tiny-icon"></i>Verify Price</a></li>

              <li> <a href="<?php echo base_url()?>canteen/Vquotation/approved/<?php echo $row->quotation_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Verify Done</a></li>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>canteen/Vquotation/delete/"+rowId;
}else{
  return false;
}
});
