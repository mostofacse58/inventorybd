...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>commonr/transportation/downloadExcel<?php 
...
<div class="box box-info">
  <!-- form start -->
  <form class="form-horizontal" action="<?php echo base_url();?>commonr/transportation/reportrResult" method="POST" enctype="multipart/form-data">
        <div class="box-body">
