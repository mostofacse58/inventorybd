...
<table style="width: 100%">
  <tr>
    ...
    <th style="width:15%;text-align: left" >TPM CODE (TPM代码):</th>
    <th style="width:30%;text-align: left" ><?php if(isset($info))echo $info->tpm_serial_code; ?></th>
    <?php }else{  ?>
    <th style="width:15%;text-align: left" valign="top">Purpose:</th>
...
<table class="tg">
  <tr>
    ...
    <th style="width:10%;text-align:center;">Issued Quantity</th>
...
<table style="width:100%">
  ...
  <td style="width:25%;text-align:center"><?php if(isset($info)) echo "$info->me_name $info->other_id"; ?></td>
