...
<table style="width: 100%">
  <tr>
    <th style="width:50%;text-align: left" > 
      Name : <?php if(isset($info)) echo "$info->requested_by"; ?></th>
    <th style="width:25%;text-align: left" > 
      SL. No: <?php if(isset($info)) echo $info->deptrequisn_no; ?> </th>
    </tr>
    <tr>
    <th style="text-align: left" > 
      Department: <?php if(isset($info)) echo $info->department_name; ?> </th>
    <th style="text-align: left" > 
     Date日期 : <?php if(isset($info)) echo findDate($info->deptrequisn_date); ?></th>
    </tr>
    <tr>
    <th style="text-align: left" > 
...
<table style="width:100%">
  ...
  <td style="width:25%;text-align:center"><?php if($info->deptrequisn_status>2) echo "$info->dept_head"; ?></td>
  <td style="width:25%;text-align:center"></td>
  <td style="width:25%;text-align:right"><?php if($info->deptrequisn_status>3) echo "$info->approved_by"; ?></td>
  </tr>
  <tr>
