...
<?php echo $this->session->userdata('caddress'); ?>                   
  ...
  <div class="box-footer">
     <div class="col-sm-6"><a href="<?php echo base_url(); ?>gatep/<?php echo $controller; ?>/lists2" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
