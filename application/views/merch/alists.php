...
var url1="<?php echo base_url(); ?>merch/Ainvoice/lists";
...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>merch/Ainvoice/add">
...
Add New
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>merch/Ainvoice/lists" method="GET" enctype="multipart/form-data">
          <div class="form-group">
            <label class="col-sm-2 control-label">Ainvoice No</label>
            <div class="col-sm-2">
              <input type="text" name="invoice_no" class="form-control" placeholder="Ainvoice No" value="<?php  echo set_value('invoice_no'); ?>" autofocus>
            </div>
          ...
          <div class="col-sm-1">
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>merch/Ainvoice/lists">All</a>
          </div>
          </div>
        </form>
        <div class="table-responsive table-bordered">
          ...
          <tr>
              ...
              <th style="width:10%;text-align:center">Ainvoice No</th>
              <th style="width:8%;text-align:center">Ainvoice Date</th>
              ...
              <?php echo $row->approved_by_name;  ?></td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li><a href="<?php echo base_url()?>merch/Ainvoice/view/<?php echo $row->invoice_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                        <li><a href="<?php echo base_url()?>dashboard/viewInpdf/<?php echo $row->invoice_id;?>"><i class="fa fa-file-pdf-o tiny-icon"></i>PDF</a></li>
                         <?php if($row->status==2){  ?>
                         <li><a href="<?php echo base_url()?>merch/Ainvoice/approved/<?php echo $row->invoice_id;?>">
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>merch/Ainvoice/delete/"+rowId;
}
});
});//jquery ends here
</script>
