...
<!-- <div class="container">
  ...
  <thead>
              <tr>
                  ...
                  <th style="text-align:center;width:10%">Taking Department</th>
                  <th style="text-align:center;width:10%">Issue Department</th>
                  <th style="text-align:center;width:10%">Location</th>
                  <th style="text-align:center;width:8%">Issue Qty</th>
              ...
              if(isset($resultdetail)&&!empty($resultdetail)): $i=1;
                foreach($resultdetail as $row):
                  $grandtotal=$grandtotal+$row->tquantity;
                  ?>
                  <tr>
                    ...
                    <td style="text-align:center;">
                      <?php echo $row->res_dept_name;  ?></td> 
                    <td style="text-align:center;">
                      <?php echo $row->mlocation_name;  ?></td>  
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->tquantity; ?></td>
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->tsub_total; ?></td>
                  </tr>
                  <?php
                  endforeach;
              endif;
