...
<!-- <div class="container">
  ...
  <thead>
              <tr>
                  ...
                  <th style="text-align:center;width:10%">From Department</th>
                  <th style="text-align:center;width:8%">Required Qty</th>
              ...
              if(isset($resultdetail)&&!empty($resultdetail)): $i=1;
                foreach($resultdetail as $row):
                  ...
                  <tr>
                    ...
                    <?php  echo $row->deptrequisn_no; ?></td>
                    <td style="text-align:center;">
                      <?php echo $row->deptrequisn_date; ?></td>
                    <td style="text-align:center;">
                    ...
                    elseif($row->deptrequisn_status==4) echo "Received";
                    ?> </td>
                  </tr>
                  <?php
                  endforeach;
