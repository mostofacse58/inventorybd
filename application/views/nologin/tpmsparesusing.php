  ...
  <thead>
              ...
              if(isset($resultdetail)&&!empty($resultdetail)): $i=1;
                foreach($resultdetail as $row):
                  $grandtotal=$grandtotal+$row->totalqty;
                  ?>
                  <tr>
                    <td style="text-align:center;">
                      <?php echo $i++; ?></td>
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->using_ref_no; ?></td>
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->use_date; ?></td>
                    <td style="text-align:center;">
                      <?php echo $row->floor_no;  ?></td>  
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->totalqty; ?></td>
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  echo $row->totatamount; ?></td>
                    <td style="vertical-align: text-top;text-align:center;">
                    <?php  if($row->use_type==1) echo "Machine"; else echo "Others"; ?></td>
                  </tr>
                  <?php
                  endforeach;
              endif;
