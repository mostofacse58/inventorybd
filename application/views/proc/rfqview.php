...
<table style="width: 100%">
  <tr>
    <th style="width:50%;text-align: left" > 
      RFQ. No: <?php if(isset($info)) echo $info->rfq_no; ?> </th>
    <th style="text-align: left" > 
      Department: <?php if(isset($info)) echo $info->department_name; ?> </th>
    </tr>
    <tr>
    <th style="width:50%;text-align: left" > 
      RFI No: <?php if(isset($info)) echo $info->rfq_no; ?> </th>
    <th style="text-align: left" > 
      Quotation NO: <?php if(isset($info)) echo $info->quotation_no; ?> </th>
    </tr>
    <tr>
    <th style="text-align: left" > 
     Date日期 : <?php if(isset($info)) echo findDate($info->rfq_date); ?></th>
    <th style="text-align: left" > 
      Quotation Date: <?php if(isset($info)) echo  findDate($info->quotation_date); ?> 
    </th>
    </tr>
    <tr>
    <th style="text-align: left" > 
     Note : <?php if(isset($info)) echo $info->note; ?></th>
  </tr>
...
<table style="width:100%">
  ...
  <td style="width:50%;text-align:left;">
    <?php if(isset($info)) echo "$info->user_name"; ?></td>
  <td style="width:50%;text-align:right">
    <?php if($info->rfq_status>2) echo "$info->approved_by"; ?></td>
  </tr>
  <tr>
  <td style="text-align:left;">
    <?php if(isset($info)) echo $info->rfq_date; ?></td>
  <td style="text-align:right">
    <?php if($info->rfq_status>2) echo $info->received_date; ?></td>
  </tr>
  <tr>
