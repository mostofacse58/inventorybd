...
<div style="width:100%;overflow:hidden;font-size: 18px;color: #000;text-align:center">
 ...
 <p style="margin:0;text-align:center;font-size: 16px;">
  ...
  <tr>
    ...
    <th class="tg-s6z2"><?php echo lang('uepz_gate_tips'); ?> </th>
    <td class="tg-baqh" > <?php echo $info->uepz_gate_tips; ?></td>
...
<?php echo $this->session->userdata('caddress'); ?>                   
  ...
  <div class="box-footer">
     <div class="col-sm-6"><a href="<?php echo base_url(); ?>shipping/<?php echo $controller; ?>/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
