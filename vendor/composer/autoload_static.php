...
class ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b
{
    ...
    public static $classMap = array (
        ...
        'Contact' => __DIR__ . '/../..' . '/application/orm/Contact.php',
        'Country' => __DIR__ . '/../..' . '/application/orm/Country.php',
        'Credit' => __DIR__ . '/../..' . '/application/orm/Credit.php',
        'Credit_details' => __DIR__ . '/../..' . '/application/orm/Credit_details.php',
        'Credit_discount' => __DIR__ . '/../..' . '/application/orm/Credit_discount.php',
        'Delivery' => __DIR__ . '/../..' . '/application/orm/Delivery.php',
        'Delivery_details' => __DIR__ . '/../..' . '/application/orm/Delivery_details.php',
        'Delivery_discount' => __DIR__ . '/../..' . '/application/orm/Delivery_discount.php',
        'File_Iterator' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Iterator.php',
        'File_Iterator_Facade' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Facade.php',
        'File_Iterator_Factory' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Factory.php',
        'Invoice' => __DIR__ . '/../..' . '/application/orm/Invoice.php',
        'Invoice_details' => __DIR__ . '/../..' . '/application/orm/Invoice_details.php',
        'Invoice_discount' => __DIR__ . '/../..' . '/application/orm/Invoice_discount.php',
        'Order' => __DIR__ . '/../..' . '/application/orm/Order.php',
        'Order_details' => __DIR__ . '/../..' . '/application/orm/Order_details.php',
        'Order_discount' => __DIR__ . '/../..' . '/application/orm/Order_discount.php',
        ...
        'Pdelivery' => __DIR__ . '/../..' . '/application/orm/Pdelivery.php',
        'Pdelivery_details' => __DIR__ . '/../..' . '/application/orm/Pdelivery_details.php',
        'PhpToken' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/PhpToken.php',
        'Proposal' => __DIR__ . '/../..' . '/application/orm/Proposal.php',
        'Proposal_details' => __DIR__ . '/../..' . '/application/orm/Proposal_details.php',
        'Proposal_discount' => __DIR__ . '/../..' . '/application/orm/Proposal_discount.php',
        'Purchase' => __DIR__ . '/../..' . '/application/orm/Purchase.php',
        'Purchase_details' => __DIR__ . '/../..' . '/application/orm/Purchase_details.php',
        'Purchase_discount' => __DIR__ . '/../..' . '/application/orm/Purchase_discount.php',
        ...
        'Sreturn' => __DIR__ . '/../..' . '/application/orm/Sreturn.php',
        'Sreturn_details' => __DIR__ . '/../..' . '/application/orm/Sreturn_details.php',
        'Sreturn_discount' => __DIR__ . '/../..' . '/application/orm/Sreturn_discount.php',
        'Stringable' => __DIR__ . '/..' . '/myclabs/php-enum/stubs/Stringable.php',
        'Text_Template' => __DIR__ . '/..' . '/phpunit/php-text-template/src/Template.php',
        'UnhandledMatchError' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/UnhandledMatchError.php',
        'User' => __DIR__ . '/../..' . '/application/orm/User.php',
        'ValueError' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/ValueError.php',
        'Warehouse' => __DIR__ . '/../..' . '/application/orm/Warehouse.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b::$prefixDirsPsr4;
            $loader->fallbackDirsPsr4 = ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b::$fallbackDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit6d2b20fae116667deaaa9730228ebe9b::$classMap;
